...
import { User, Mail, Phone, Stethoscope, Calendar, Clock, CheckCircle, XCircle, Edit2, Save, X, LogOut, Activity, AlertCircle, FileText, Plus, Eye } from "lucide-react";
...
function Profile() {
  ...
  // Fetch case records when modal opens
  useEffect(() => {
    if (showCaseRecords) {
      fetchCaseRecords();
    }
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-6xl w-full p-8 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl font-bold text-gray-800">All Case Records</h3>
              </div>
              <button
            ...
            {caseRecords.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 font-medium">No case records found</p>
                <p className="text-sm text-gray-400 mt-1">Add your first case record to get started</p>
              </div>
            ) : (
              <div className="space-y-4">
                {caseRecords.map((record) => (
                  <div key={record._id} className="bg-gray-50 rounded-xl p-6 border border-gray-200 hover:shadow-md transition-shadow">
