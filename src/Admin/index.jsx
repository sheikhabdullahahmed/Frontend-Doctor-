...
// import { Users, UserCheck, Calendar, Activity, CheckCircle, Trash2, XCircle, Clock } from "lucide-react";
...
//     await axios.put(`${BASE_URL}/doctors/${id}`, { status: "approved" });
//     setDoctors(doctors.map(d => d._id === id ? {...d, status: "approved"} : d));
//   };
...
//                 Admin Dashboard
//               </h1>
//               <p className="text-gray-500 mt-1">Manage your healthcare system</p>
//             </div>
...
//                             </div>
//                             <div>
//                               <p className="font-semibold text-gray-900">{pat.name}</p>
//                               <p className="text-xs text-gray-500">{pat.phone}</p>
//                             </div>
//                           </div>
//                         </td>
//                         <td className="px-6 py-4 text-sm text-gray-600">{pat.email}</td>
//                         <td className="px-6 py-4">
//                           <button
...
//                             </div>
//                             <p className="font-semibold text-gray-900">{a.doctorId?.name}</p>
//                           </div>
//                         </td>
//                         <td className="px-6 py-4">
//                           <div className="flex items-center gap-3">
...
//                             </div>
//                             <p className="font-semibold text-gray-900">{a.patientId?.name}</p>
//                           </div>
//                         </td>
//                         <td className="px-6 py-4">
//                           <div className="flex items-center gap-2">
//                             <Calendar className="w-4 h-4 text-gray-400" />
//                             <span className="text-sm text-gray-600">{new Date(a.date).toLocaleDateString()}</span>
//                           </div>
//                         </td>
//                         <td className="px-6 py-4">
//                           <button
